...
require_once (dirname(dirname(__FILE__)) . '/vendor/Net/DNS.php');
...
function resolveLSID ($l)
{
	...
	{
		$xml .= "<error_codes"
		. " HTTP=\"" . $authority->http_code . "\""
		. " LSID=\"" . $authority->lsid_code . "\""
		. " CURL=\"" . $authority->curl_code . "\""
		. " />\n";	
...
if (0)
{
	$lsid = 'urn:lsid:indexfungorum.org:names:160488';

	//$lsid = 'urn:lsid:zoobank.org:pub:07F31CA2-C201-4DB5-86DB-30FCF579AB78';
	
	$lsid = 'urn:lsid:biosci.ohio-state.edu:osuc_concepts:96260';
	$lsid = 'urn:lsid:biosci.ohio-state.edu:osuc_citations:218241';
	
	// Doesn't resolve
	$lsid = 'urn:lsid:catalogueoflife.org:taxon:d2386260-2dc5-11e0-98c6-2ce70255a436:col20110201';
	
	// Works
	$lsid = 'urn:lsid:amnh.org:spidersp:019664';
	
	// Fauna Europeana (fail)
	$lsid = 'urn:lsid:faunaeur.org:taxname:238453';
	
	$lsid = 'urn:lsid:marinespecies.org:taxname:107451';
	
	// Animalia
	$lsid = 'urn:lsid:catalogueoflife.org:taxon:d74fcd5e-29c1-102b-9a4a-00304854f820:ac2010';
	$lsid = 'urn:lsid:catalogueoflife.org:taxon:d74fcd5e-29c1-102b-9a4a-00304854f820:col20101221';
	
	$lsid = 'urn:lsid:biodiversity.org.au:afd.taxon:f5b22be3-b523-488a-89fc-39bd21aefb6d';
	$lsid = 'urn:lsid:biodiversity.org.au:afd.name:433239';
	$lsid = 'urn:lsid:biodiversity.org.au:col.name:6847559';
	
	$lsid = 'urn:lsid:biosci.ohio-state.edu:osuc_names:238242';
	$lsid = 'urn:lsid:zoobank.org:act:5AA365A2-2479-4959-BF33-45C64E746A1F';
	$lsid = 'urn:lsid:zoobank.org:pub:DB40E879-7719-455B-9480-B20F834EB60E';
	$lsid = 'urn:lsid:zoobank.org:pub:2B1CD8DB-908B-424A-BC36-5906E4D0ECEE';
	
	//$lsid = 'urn:lsid:biodiversity.org.au:afd.name:289840';
	...
	// need to convert this to JSON-LD (maybe)	
